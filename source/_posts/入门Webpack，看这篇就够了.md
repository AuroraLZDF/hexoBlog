...
WebPack可以看做是<strong>模块打包机</strong>：它做的事情是，分析你的项目结构，找到JavaScript模块以及其它的一些浏览器不能直接运行的拓展语言（Scss，TypeScript等），并将其打包为合适的格式以供浏览器使用。
...
<img src='/images/webpack_demo.png' />
...
<img src='/images/webpack_result1.png' />
...
<img src='/images/webpack_bash.png' />
...
文章出处：[zhangwang：入门Webpack，看这篇就够了](http://www.jianshu.com/p/42e11515c10f)，感谢分享！